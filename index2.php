...
<nav class="navbar navbar-expand-md navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarMenu">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="src/about1.php">About Us</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="src/services1.php">Services</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="src/contact1.php">Contact Us</a>
            </li>
            <li class="nav-item">
...
<h3 align="right">Hello, <?php echo $_SESSION['name']; ?></h3>
...
<div id="form">
    <div class="container">
        <div class="row">
            <div class="col">
                <img alt="Form Picture" src="img/form-pic.png">
            </div>
            <div class="col" id='register'>
                <h2>Register For 1 Week Free Trail</h2>
                <form method="post" action="connect.php" >
                    <div class="row form-group">
                        <div class="col">
                            <label for="inputName1">First Name</label>
                            <input class="form-control" id="inputName1" name="firstName" placeholder="First Name" type="text">
                        </div>
                        <div class="col">
                            <label for="inputName2">Last Name</label>
                            <input class="form-control" id="inputName2" name="lastName" placeholder="Last Name" type="text">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputEmail">Email</label>
                        <input class="form-control" id="inputEmail" name="email" placeholder="Enter Your Email Id" type="text">
                    </div>
                    <div class="form-group">
                        <label for="inputContact">Contact</label>
                        <input class="form-control" id="inputContact" name="number" placeholder="Enter Your Phone Number" type="text">
                    </div>
                    <div class="form-group">
                        <label for="inputGendert">Gender</label>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" id="inlineRadio1" name="gender" type="radio"
                                   value="male">
                    ...
                    <button class="btn btn-primary" id='btn-form' name="save" type="submit">Submit</button>
                </form>
            </div>
        </div>
    </div>
